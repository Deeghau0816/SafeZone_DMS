  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, marginTop: '0', paddingTop: '0' }}>
        ...
        {/* NGO Standalone Routes */}
        <Route path="/ngo/distribution-chart" element={<DistributionQuantityChart />} />
