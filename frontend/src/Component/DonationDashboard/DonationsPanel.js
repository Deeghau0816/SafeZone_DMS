    ...
    <div className="ngo-wrap">
      <div className="ngo-head">
        ...
        <div className="row gap8">
          <button className="ngo-btn" onClick={() => navigate("/ngo-dashboard/donations/top")}>
            Top donors
          </button>
                  ...
                  <tr key={d._id || d.id}>
                    ...
                    <td className="ngo-tight">
                      <div className="ngo-rowacts">
                        ...
                        <button className="ngoo-btn" onClick={() => navigate(`/ngo-dashboard/donations/${d._id || d.id}/edit`)}>
                          Edit
                        </button>
